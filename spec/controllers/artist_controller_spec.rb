...
RSpec.describe ArtistsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested artists as @artists and renders the show template" do
      artist = create(:artist)
  ...
  describe "GET #new" do
    it "creates a new artists as @artist" do
      get(:new)
  ...
  describe "GET #edit" do
    it "assisgns the requested artist as @artist" do
      artist = create(:artist)
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns newly created but unsaved artiast as @artist" do
